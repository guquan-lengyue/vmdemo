...
import { usbApi } from '../api.js'

const props = defineProps({
  cfg: {
    type: Object,
    default: () => ({
      attachedDevices: [] // 存储已挂载的USB设备ID列表
    }),
  },
})
...
const fetchUsbDevices = async () => {
  loading.value = true
  try {
    const devices = await usbApi.listUsbDevices()
